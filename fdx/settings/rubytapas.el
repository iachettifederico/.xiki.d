...
(defun make-rubytapas-frame ()
  ...
  (let* ((color-theme-is-global nil)
    ...
    (set-frame-font "Inconsolata:pixelsize=52:foundry=unknown:weight=normal:slant=normal:width=normal:spacing=100:scalable=true" nil)
      ...
      (capitalize
       (replace-regexp-in-string "[0-9x]\\{3\\}-" ""
                                 (file-name-sans-extension
                                  (file-name-nondiectory buffer-file-name)))))))

(global-set-key (kbd "C-<f11>") 'make-rubytapas-frame)
